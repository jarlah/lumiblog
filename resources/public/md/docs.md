...
Two middleware functions are provided by default in the `test-app.middleware` namespace.
...
See the `:middleware` key of the `app` definition located in the `test-app.handler` namespace to manage the enabled middleware.
